        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-8">
          ...
          >
            <Button
              ...
              className="text-white transition-transform duration-200 hover:scale-105 px-12 py-6 text-lg w-full"
            >
          ...
          <Button
            ...
            className="!border-2 !border-white !text-white bg-transparent hover:!bg-white hover:!text-blue-600 transition-transform duration-200 hover:scale-105 px-12 py-6 text-lg"
          >
